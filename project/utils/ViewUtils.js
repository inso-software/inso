        ...
        return (
            <TouchableHighlight
                ...
                <View style={[styles.setting_item_container]}>
                    ...
                    <Image source={expandableIco ? expandableIco : require('../resource/title/back_white_normal.png')}
                           style={[{
                               marginRight: 10,
                               height: 22,
                               width: 22,
    ...
    static getLeftButton(callBack) {
        return <TouchableOpacity
            ...
            <Image
                ...
                source={require('../resource/title/back_white_normal.png')}/>
        </TouchableOpacity>
    }
        ...
        >
            <View style={{paddingRight: 8}}>
                <Image
                    ...
                    source={require('../resource/title/more_white_normal.png')}
                />
            </View>
        </TouchableHighlight>
    }
    ...
    static getShareButton(callBack) {
        ...
        >
            <Image
                ...
                source={require('../resource/title/share_white_normal.png')}/>
        </TouchableHighlight>
    }
}
