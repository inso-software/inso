...
export default class TitleBar extends Component {
    ...
    render() {
        ...
        return (
            <SafeAreaView style={[styles.titleBarContainer, this.props.style, dark ? { backgroundColor: '#19191D' } : {}]}>
                <View style={{ flex: 1, flexDirection: 'row', alignItems: 'center', paddingLeft: marginBetWeenImgs }}>
                    ...
                    <ImageButton
                        ...
                        source={
                            dark ?
                                require('../../../resource/title/back_white_normal.png') :
                                require('../../../resource/title/back_normal.png')
                        }
                        highlightedSource={
                            dark ?
                                require('../../../resource/title/back_white_press.png') :
                                require('../../../resource/title/back_press.png')
                        }
                    />
                    }
                    {this.props.leftText ?
                        ...
                        (this.props.onPressLeft2 &&
                            <ImageButton
                                ...
                                source={
                                    dark ?
                                        require('../../../resource/title/close_white_normal.png') :
                                        require('../../../resource/title/close_normal.png')
                                }
                                highlightedSource={
                                    dark ?
                                        require('../../../resource/title/close_white_press.png') :
                                        require('../../../resource/title/close_press.png')
                                }
                            />
                        )
                    }
                ...
                <View style={{ flex: 1, flexDirection: 'row', alignItems: 'center', paddingRight: marginBetWeenImgs }}>
                    ...
                    <ImageButton
                        ...
                        source={
                            dark ?
                                require('../../../resource/title/share_white_normal.png') :
                                require('../../../resource/title/share_normal.png')
                        }
                        highlightedSource={
                            dark ?
                                require('../../../resource/title/share_white_press.png') :
                                require('../../../resource/title/share_press.png')
                        }
                    />
                    }
                        ...
                        (this.props.onPressRight2 &&
                            <View style={[styles.img, { marginLeft: marginBetWeenImgs }]}>
                                <ImageButton
                                    ...
                                    source={
                                        dark ?
                                            require('../../../resource/title/more_white_normal.png') :
                                            require('../../../resource/title/more_normal.png')
                                    }
                                    highlightedSource={
                                        dark ?
                                            require('../../../resource/title/more_white_press.png') :
                                            require('../../../resource/title/more_press.png')
                                    }
                                />
                                {this.props.showDot &&
                                <Image
                                    style={styles.dot}
                                    source={require('../../../resource/title/dot.png')}
                                />
                                }
                            </View>
                        )
